...
const CarouselItem = React.forwardRef(({ className, ...props }, ref) => {
  return (
    <div
      ...
      className={cn('tw-min-w-0 tw-shrink-0 tw-grow-0 tw-basis-full', className)}
      {...props}
    />
  );
});
...
const CarouselPrevious = React.forwardRef(({ className, ...props }, ref) => {
  ...
  return (
    <Button
      ...
      variant="outline"
      size="icon"
      className={cn('tw-absolute tw-left-1 tw-top-1/2 -tw-translate-y-1/2', className)}
...
const CarouselNext = React.forwardRef(({ className, ...props }, ref) => {
  ...
  return (
    <Button
      ...
      variant="outline"
      size="icon"
      className={cn('tw-absolute tw-right-1 tw-top-1/2 -tw-translate-y-1/2', className)}
