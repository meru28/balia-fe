        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <SidebarMenuButton
              ...
              <div
                className="tw-flex tw-aspect-square tw-size-8 tw-items-center tw-justify-center tw-rounded-lg tw-bg-sidebar-primary tw-text-sidebar-primary-foreground">
          ...
          <DropdownMenuContent
            ...
            <DropdownMenuItem className="tw-gap-2 tw-p-2">
              <div
                className="tw-flex tw-size-6 tw-items-center tw-justify-center tw-rounded-md tw-border tw-bg-background">
